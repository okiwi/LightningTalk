...
public class SessionPourLaPresentationTest {
    ...
    @Test
    public void encodeCaractereSpeciauxDansGetDescriptionEncodePourJavascript() throws UnsupportedEncodingException, ImpossibleDeCreerUneSession {
        when(session.getDescription()).thenReturn("un chtit' description");
        
        String titreEncodePourJavascript = sessionPourLaPresentation.getDescriptionEncodePourJavascript();
        
        assertThat(titreEncodePourJavascript, is("un chtit\\' description"));
        verify(session).getDescription();
    }
    
    @Test
    public void peutRecupererLaDescriptionEncodePourJavascript() throws UnsupportedEncodingException, ImpossibleDeCreerUneSession {
        when(session.getDescription()).thenReturn(AidePourLesSessions.DESCRIPTION);
        
        String titreEncodePourJavascript = sessionPourLaPresentation.getDescriptionEncodePourJavascript();
        
        assertThat(titreEncodePourJavascript, is(AidePourLesSessions.DESCRIPTION));
        verify(session).getDescription();
    }
